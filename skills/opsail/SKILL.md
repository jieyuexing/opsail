---
name: opsail
description: Use the Opsail native CLI for readable HTML extraction, sparse local XLSX range reading, CLI remaining-usage queries, and the target-validated Codex sidebar usage refit.
license: Apache-2.0
